...
// Validate ../../app/api/root/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/root">> = Specific
  const handler = {} as typeof import("../../app/api/root/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
